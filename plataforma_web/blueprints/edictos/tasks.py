...
def refrescar(autoridad_id: int, usuario_id: int = None):
    ...
    bitacora.info("- Tiene %d edictos en la base de datos", total_en_bd)
    archivos = [edicto.archivo for edicto in edictos]
    ...
    # Bucle por los archivos en el depósito AAAA-MM-DD-EEEE-EEEE-NUMP-NUMP-DESCRIPCION-BLA-BLA-IDHASED.pdf
    for blob in blobs:
