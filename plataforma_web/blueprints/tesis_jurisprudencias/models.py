...
class TesisJurisprudencia(db.Model, UniversalMixin):
    ...
    clave_control = db.Column(db.String(256), nullable=False, default="", server_default="")  # Clave de control (Como se indica en los lineamientos)
    ...
    texto = db.Column(db.Text(), nullable=False, default="", server_default="")  # Texto (En su caso archivo a subir en la plataforma)
    precedentes = db.Column(
    ...
    magistrado_ponente = db.Column(db.String(256), nullable=False, default="", server_default="")  # Magistrado ponente (Nombre del magistrado ponente)
