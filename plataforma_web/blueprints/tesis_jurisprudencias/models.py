...
class TesisJurisprudencia(db.Model, UniversalMixin):
    ...
    # Clave foránea Magistrado ponente
    funcionario_id = db.Column(db.Integer, db.ForeignKey("funcionarios.id"), index=True, nullable=False)
    funcionario = db.relationship("Funcionario", back_populates="tesis_jurisprudencias")
    ...
    precedentes = db.Column(db.Text(), nullable=False, default="", server_default="")  # Precedentes que sustentan las tesis
